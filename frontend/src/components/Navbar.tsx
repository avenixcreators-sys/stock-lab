...
import { Home, TrendingUp, Briefcase, Star, BookOpen, User, LogOut, Menu, X, Sun, Moon, Bot } from 'lucide-react';
      ...
      <nav className="fixed inset-x-0 top-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.png" alt="StockLab logo" className="w-[2cm] h-[2cm] rounded-2xl object-cover shrink-0" />
